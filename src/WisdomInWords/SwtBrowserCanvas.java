...
/**
 * Implementation of an AWT {@link java.awt.Canvas} that embeds an SWT {@link org.eclipse.swt.browser.Browser} component.
 * <p>
 ...
 *       shutdown from inside a {@link java.awt.event.WindowListener#windowClosing(java.awt.event.WindowEvent)} implementation in
...
public final class SwtBrowserCanvas extends Canvas {
    ...
    static final SwtBrowserCanvas browserCanvas = new SwtBrowserCanvas();
    /**
     ...
     */
    private final AtomicReference<Browser> browserReference = new AtomicReference<Browser>();

    /**
     * SWT event dispatch thread reference.
     */
    private final AtomicReference<SwtThread> swtThreadReference = new AtomicReference<SwtThread>();
     ...
     * <p>
     * This should be called from a {@link java.awt.event.WindowListener#windowClosing(java.awt.event.WindowEvent)} implementation.
     */
    public void dispose() {
    ...
    public static void main(String[] args) {
        ...
        if (browserCanvas.initialise()) {
            ...
            //browserCanvas.setUrl("https://translate.google.com/?hl=ru#en/ru/bing");
            browserCanvas.setUrl("https://google.com/");
        }
        else {
    ...
    public static JPanel addBrowserToFrame (JFrame frame) {
        ...
        frame.setVisible(true);
        //frame.setContentPane(contentPane);
        frame.getContentPane().add(contentPane);//, BorderLayout.PAGE_END);

        // Initialise the native browser component, and if successful...
        if (browserCanvas.initialise()) {
            // ...navigate to the desired URL
            browserCanvas.setUrl("about:blank");
        }
        else {
            System.out.println("Failed to initialise browser");
        }
    ...
    public static void browserCanvasSetUrl(String link) {

        browserCanvas.setUrl(link);
